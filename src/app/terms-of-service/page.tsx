...
const sections = [
  {
    ...
    body: (
      <>
        <p>
          This website is operated by TRAKK. Throughout the site, the terms
          &ldquo;we,&rdquo; &ldquo;us,&rdquo; and &ldquo;our&rdquo; refer to
          TRAKK. TRAKK offers this website, including all information, tools,
    ...
    body: (
      <>
        <p>
          ...
          least the age of majority in your province or territory of residence
          (18 years of age in Alberta), or that you are the age of majority and
    ...
    body: (
      <>
        ...
        <p>
          ...
          guarantee that your computer monitor&rsquo;s display of any colour
          will be accurate.
        </p>
        <p>
          ...
          subject to change at any time without notice, at the sole discretion
    ...
    body: (
      <>
        ...
        <p>
          ...
          carefully the third party&rsquo;s policies and practices and make
    ...
    body: (
      <>
        ...
        <p>
          ...
          any way affect the operation of the Service or any related website.
          You may not use a false email address, pretend to be someone other
    ...
    body: (
      <>
        ...
        <p>
          ...
          stated by us) provided &lsquo;as is&rsquo; and &lsquo;as
          available&rsquo; for your use, without any representation, warranties,
        ...
        <p>
          In no case shall TRAKK, our directors, officers, employees,
          ...
          incidental damages, in such provinces or jurisdictions, our liability
  ...
  },
  {
    ...
    body: (
      <p>
        You agree to indemnify, defend, and hold harmless TRAKK and our
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        applicable therein. You agree to submit to the exclusive jurisdiction
        of the courts located in Edmonton, Alberta for the resolution of any
        disputes.
      </p>
    ),
  },
    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex flex-1 flex-col">
        <PageHero
          ...
          description="Effective date: July 8, 2026"
        />
